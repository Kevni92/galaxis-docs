...
1. Vor jeder Aufgabe lesen: `README.md`, `WORKFLOW.md`, `TESTING.md`, `SOURCE-CODE.md`, `docs/conventions.md` sowie die relevanten Fach-, Vertrags- und Entscheidungsdokumente.
